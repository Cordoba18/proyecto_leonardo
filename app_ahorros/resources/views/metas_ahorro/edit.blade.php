            ...
            <div class="card text-bg-success justify-content-center p-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route("metas_ahorro.editar.guardar") }}" method="post">
                        ...
                        <input type="number" value="{{$meta_ahorro->id}}" hidden name="id_meta_ahorro">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">NOMBRE DE LA META</label>
                            <input type="text" value="{{$meta_ahorro->nombre}}" name="nombre" class="form-control" id="exampleFormControlInput1"
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input required type="number" name="valor" class="form-control" id="exampleFormControlInput1"
                                placeholder="Ingrese el valor a alcanzar" value="{{$meta_ahorro->valor}}">
                        </div>
...
<div class="d-flex justify-content-center"><input required type="date"
        id="fecha_inicio" name="fecha_inicio" max="{{$meta_ahorro->fecha_final}}" value="{{$meta_ahorro->fecha_inicio}}"
        class="form-control">
</div>
</div>
...
<div class="mb-3"> <label for="exampleFormControlInput1" class="form-label">FECHA DE FINAL</label>
    <div class="d-flex justify-content-center"><input required type="date"
            id="fecha_final" name="fecha_final" min="{{$meta_ahorro->fecha_inicio}}" value="{{$meta_ahorro->fecha_final}}"
            class="form-control">
    </div>
    </div>
